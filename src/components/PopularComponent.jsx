          ...
          <div className='popular-entities'>
            ...
            <Row gutter={16}>
              <Col className='ant-col-sm-24 ant-col-lg-6'>
                <Card hoverable cover={<img alt='example' src={serviceOne} />}>
                  <Meta
              ...
              <Col className='ant-col-sm-24 ant-col-lg-6'>
                <Card hoverable cover={<img alt='example' src={serviceTwo} />}>
                  <Meta
              ...
              <Col className='ant-col-sm-24 ant-col-lg-6'>
                <Card hoverable cover={<img alt='example' src={serviceFour} />}>
                  <Meta
