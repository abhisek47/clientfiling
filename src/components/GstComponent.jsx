          ...
          <div className='gst-main'>
            <Row gutter={16}>
              ...
              <Col className='ant-col-md-16 ant-col-lg-18'>
                {/* registration info */}
                <div className='gst-reg' id='gst-reg'>
                  <Typography>
                    ...
                    <Paragraph strong>
                      ...
                      etc) has to register under GST if the total turnover
                      crosses Rs.40 lakh (Rs.20 lakh in case of north eastern
                      states). Hence, if your turnover is more than 40 lakh or
                      is going to be more than 20 lakh, then it is advised that
                      you should go for GST registration.
                    </Paragraph>
                  </Typography>
                </div>
                {/* Pricing info */}
                ...
                />
                {/* mandatory cases */}
                <div className='gst-cases' id='gst-cases'>
                ...
                {/* documents */}
                <div className='gst-docs' id='gst-docs'>
                ...
                {/* faq */}
                <div className='gst-faq' id='gst-faq'>
