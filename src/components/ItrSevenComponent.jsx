...
// import itrSevenIneligibility from '../assets/itrSeven-ineligibility.svg';
        ...
        <div className='gst-main'>
          <Row gutter={16}>
            ...
            <Col className='ant-col-md-16 ant-col-lg-18'>
              ...
              {/* #itrSeven ineligibility */}
              {/* <div
                className='itrSeven-ineligibility service'
                id='itrSeven-ineligibility'>
                <Title>Ineligibility to file ITR-7</Title>
                <Paragraph strong>
                ...
                <Row gutter={14} align='middle'>
                  <Col className='ant-col-lg-12 ant-col-sm-24'>
                    <img src={itrSevenIneligibility} alt='gstr-cases' />
                  </Col>
                  <Col className='ant-col-lg-12 ant-col-sm-24'>
                    <List
